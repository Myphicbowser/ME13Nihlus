...
#define INDEP_ROLES list(NON_CREW_CIVILIAN_ROLES, CONSULAR_ROLE, JOURNALIST_ROLE, CHAPLAIN_ROLE, OFF_DUTY_CREW_MEMBER_ROLE, CIVILIAN_ROLES, SERVICE_ROLES)

#define CF_ROLES list(COMMAND_ROLES, COMMAND_SUPPORT_ROLES, EQUIPMENT_ROLES, OFF_DUTY_CREW_MEMBER_ROLE, SECURITY_ROLES, MEDICAL_ROLES, ENGINEERING_ROLES)
#define ERCS_ROLES list(SECURITY_ROLES)
#define SIRTA_ROLES list(SCIENCE_ROLES, MEDICAL_ROLES)
#define ARIAKE_ROLES list(SCIENCE_ROLES)
#define ARMALI_ROLES list(SCIENCE_ROLES, MEDICAL_ROLES)
#define SERRICE_ROLES list(SCIENCE_ROLES, MEDICAL_ROLES)
#define SYNTH_ROLES list(SCIENCE_ROLES)
#define HELIX_ROLES list(SCIENCE_ROLES, MEDICAL_ROLES)
#define EXOGENI_ROLES list(SCIENCE_ROLES, MEDICAL_ROLES)
#define ELKOSS_ROLES list(REPRESENTATIVE_ROLE, OPERATIONS_ROLES, NON_CREW_CIVILIAN_ROLES, ENGINEERING_ROLES, MEDICAL_ROLES, SCIENCE_ROLES, SERVICE_ROLES, SECURITY_ROLES)
#define EXSOLAR_ROLES list(OPERATIONS_ROLES)
