/obj/machinery/suit_cycler
	...
	var/list/species = list(BODYTYPE_HUMAN, BODYTYPE_KROGAN, BODYTYPE_SALARIAN, BODYTYPE_TURIAN) //asari bodytype when we get sprites, otherwise human stuff fits
...
/obj/machinery/suit_cycler/engineering
	...
	species = list(BODYTYPE_HUMAN, BODYTYPE_ASARI, BODYTYPE_KROGAN, BODYTYPE_SALARIAN, BODYTYPE_TURIAN)
